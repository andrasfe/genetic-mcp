...
from genetic_mcp.models import (
    Session, Idea, Worker, FitnessWeights, 
    GeneticParameters, EvolutionMode, WorkerStatus
)
...
class TestPersistenceManager:
    ...
    async def test_save_and_load_session(self, persistence_manager, sample_session):
        ...
        for original, loaded in zip(sample_session.ideas, loaded_session.ideas):
        ...
        for original, loaded in zip(sample_session.workers, loaded_session.workers):
            assert loaded.id == original.id
